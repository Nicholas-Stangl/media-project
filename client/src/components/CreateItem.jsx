...
const CreateItem = () => {
    ...
    return (
        <div className="container">
            ...
            <h1 className="text-center text-light">Add a Reccomendation</h1>
            <form className="col-4 mx-auto" onSubmit={submitHandler}>
                <div className="form-group">
                    <label className="text-light" htmlFor="">Title:</label>
                ...
                <div class="form-group">
                    <label className="text-light" htmlFor="">Type</label>
                ...
                <div class="form-group">
                    <label className="text-light" htmlFor="">Description:</label>
                ...
                <h4 className="text-light">(Optional)</h4>

                <div className="form-group">
                <label className="text-light" htmlFor="">Release Date Date:</label>
                <input type="date" name="release_date" className="form-control" onChange={changeHandler}/>
                </div>
                
                <div className="form-group">
                    <label className="text-light" htmlFor="">Reccomended By:</label>
                    <input type="text" name="rec_by" className="form-control" onChange={changeHandler} />
                </div>

                <div className="form-group">
                    <label className="text-light" htmlFor="">Picture:</label>
                    <input type="text" name="pic" className="form-control" onChange={changeHandler} />
                </div>

                <div className="form-group">
                    <label className="text-light" htmlFor="">Trailer Link:</label>
